package com.example.fareed.lazeezoserver.Helper;
...
/**
 * Created by fareed on 14/04/2018.
 */

public class NotificationHelper extends ContextWrapper {

    private static final String lazeezo_channel_id="com.example.fareed.lazeezoserver.";
